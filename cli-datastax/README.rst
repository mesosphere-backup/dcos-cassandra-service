...
#. Clone git repo for the dcos datastax cli::
...
#. Call the CLI code directly::
    ...
    python dcos_datastax/cli.py datastax connection
...
#. Update `PATH` to have the dcos-datastax binary. The created binary is is in folder `dist`::

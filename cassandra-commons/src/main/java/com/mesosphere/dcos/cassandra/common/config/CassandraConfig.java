...
public class CassandraConfig {
  ...
  public static class Builder {
    ...
    private Builder(CassandraConfig config) {
      ...
      this.dseConfig = config.dseConfig;
    }
    ...
    public Builder setDseConfig(final DseConfig dseConfig) {
  ...
  @JsonProperty("dse")
  private final DseConfig dseConfig;
  ...
  public boolean equals(Object o) {
    ...
    return Double.compare(that.getCpus(), getCpus()) == 0 &&
      ...
      Objects.equals(getDse(),that.getDse());
  }

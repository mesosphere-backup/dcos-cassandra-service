...
```
$ dcos cassandra --framework-name=<framework-name> node status <nodeid>
```
...
Run the following CLI command to view general information about a node:

```
$ dcos cassandra --framework-name=<framework-name> node describe <nodeid>
```
...
```
$ dcos cassandra --framework-name=<framework-name> cleanup --nodes=<nodes> --key_spaces=<key_spaces> --column_families=<column_families>
```
...
```
$ dcos cassandra --framework-name=<framework-name> repair --nodes=<nodes> --key_spaces=<key_spaces> --column_families=<column_families>
```
...
```
$ dcos cassandra --framework-name=<framework-name> backup status
```

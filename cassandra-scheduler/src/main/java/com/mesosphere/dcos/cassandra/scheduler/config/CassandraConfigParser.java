...
public class CassandraConfigParser {
  ...
  private CassandraApplicationConfig getApplicationConfig(
    ...
    return create(name,
      ...
      DEFAULT_INTERNODE_AUTHENTICATOR,
  ...
  public CassandraConfigParser setMaxHintsFileSizeInMb(int maxHintsFileSizeInMb) {
  ...
  public CassandraConfigParser setHintsFlushPeriodInMs(int hintsFlushPeriodInMs) {
  ...
  public CassandraConfigParser setConcurrentMaterializedViewWrites(int concurrentMaterializedViewWrites) {
  ...
  public CassandraConfigParser setCommitlogTotalSpaceInMb(int commitlogTotalSpaceInMb) {

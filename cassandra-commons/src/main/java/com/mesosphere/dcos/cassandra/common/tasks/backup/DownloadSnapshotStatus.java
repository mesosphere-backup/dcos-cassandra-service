...
public class DownloadSnapshotStatus extends CassandraTaskStatus {
    ...
    /**
     * Creates a DownloadSnapshotStatus
     ...
     * @return A DownloadSnapshotStatus constructed from the parameters.
     */
    @JsonCreator
    public static DownloadSnapshotStatus create(
        ...
        return new DownloadSnapshotStatus(state, id, slaveId, executorId,
                message);
    }

    /**
     * Constructs a DownloadSnapshotStatus
     * @param state      The state of the task
     * @param id         The id of the task associated with the status.
     * @param slaveId    The id of the slave on which the task associated
     *                   with the status was launched.

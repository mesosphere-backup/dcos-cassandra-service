...
/**
 * This class encapsulates a Cassandra Daemon as well as a template task which reserves reosources for sidecar tasks
 * like Backup, Upload, Restore and Download
 */
